  ...
  cmd.handler = async function (argv) {
    ...
    if (argv.slackWebhookUrl) {
      await slackMessenger({
        ...
        message: `\`${argv.repo}\`: The downstream branch \`${argv.targetBranch}\` has been created sucessfully (https://github.com/${argv.owner}/${argv.repo}/tree/${argv.targetBranch}). A PR has been created at ${pullRequest.data.html_url}.`
      })
    }
